In this thesis, we take the designer's standpoint. A certain aspect of the
...
power-temperature interplay, which is also covered in \sref{power-model} as well
as in \sref{power-temperature}, whose magnitude depends on process parameters.
