...
defined in \sref{probability-theory}, and let a function $g: D \to \real$ depend
...
of $\v{x}$, which means that $F$ and $f$ in \eref{polynomial-inner-product} are
...
\eref{polynomial-inner-product} corresponds to the covariance operator, and
...
shown in \sref{probability-transformation}. Another solutions is to construct a
