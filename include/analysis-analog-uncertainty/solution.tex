...
The covariance function $k$ is chosen to be as follows:
\begin{equation} \elab{inference-covariance}
  k(\v{r}_1, \v{r}_2) = \sigma_\g^2 \left(w \, k_\SE(\v{r}_1, \v{r}_2) + (1 - w) k_\OU(\v{r}_1, \v{r}_2)\right)
\end{equation}
