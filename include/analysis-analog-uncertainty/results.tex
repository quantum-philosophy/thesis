...
the model-order-reduction procedure described in \sref{linear-algebra} and
utilized in \eref{inference-reduction} should be set high enough to preserve a
...
to the burn-in period mentioned in \sref{bayesian-statistics}, and the second
one populates $G$ with $\nm = 5 \times 10^3$ elements. For the optimization in
