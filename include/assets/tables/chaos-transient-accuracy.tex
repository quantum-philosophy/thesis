...
\begin{sidewaystable}
  \centering
  \vspace{2em}
  \caption{Accuracy when the Ornstein--Uhlenbeck kernel dominates}
  ...
  \end{tabloid}
  \vspace{0.5em}
  \caption{Accuracy when the correlation kernels are balanced}
  ...
  \end{tabloid}
  \vspace{0.5em}
  \caption{Accuracy when the squared-exponential kernel dominates}
