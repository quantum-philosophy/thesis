\newenvironment{tabloid}
{
  ...
  \begin{tabular}{crrrrrrrrrrrr}
    \toprule
    & \textnormal{$\epsilon_{\expectation}$, \%}
    & \textnormal{$\epsilon_{\expectation}$, \%}
    & \textnormal{$\epsilon_{\expectation}$, \%}
    & \textnormal{$\epsilon_{\expectation}$, \%}
    & \textnormal{$\epsilon_{\variance}$, \%}
    & \textnormal{$\epsilon_{\variance}$, \%}
    & \textnormal{$\epsilon_{\variance}$, \%}
    & \textnormal{$\epsilon_{\variance}$, \%}
    & \textnormal{$\epsilon_f$, \%}
...
\begin{sidewaystable}
  \centering
  \vspace{2em}
  \caption{Error measurements for $w = 0$ and various \up{PC} accuracy levels \lc and numbers of \up{MC} samples.}
  \vspace{-0.5em}
  \begin{tabloid}
  ...
  \end{tabloid}
  \tlab{chaos-accuracy-0}
  \vspace{0.5em}
  \caption{Error measurements for $w = 0.5$ and various \up{PC} accuracy levels \lc and numbers of \up{MC} samples \no.}
  \vspace{-0.5em}
  \begin{tabloid}
  ...
  \end{tabloid}
  \tlab{chaos-accuracy-0-5}
  \vspace{0.5em}
  \caption{Error measurements for $w = 1$ and various \up{PC} accuracy levels \lc and numbers of \up{MC} samples \no.}
  \vspace{-0.5em}
  \begin{tabloid}
