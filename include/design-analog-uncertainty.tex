...
The goal now is to transform the recurrence in \eref{transient-state-recurrence}
...
term $\vp_i$ in \eref{transient-state-recurrence} as described in
...
It can be seen in \eref{transient-state-recurrence} that, due to the linearity
...
\begin{equation} \elab{analog-chaos-recurrence}
...
\eref{analog-chaos-recurrence}, the computation of $\hat{\vp}_{ij}$ should be
done with respect to the \ac{PC} expansion of $\vq_{i - 1}$.
