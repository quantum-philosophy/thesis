...
We proceed as follows. \sref{analog-prior} provides an overview of the prior
work. The objective of our study is formulated in \sref{analog-problem}. The
proposed framework is presented in \sref{analog-solution}. A particular
application of our approach is discussed in \sref{analog-example}, and the
...
\cite{juan2011}, and \emph{a priori} chosen distributions of power and
temperature \cite{srivastava2010, juan2012, bhardwaj2006}. Consequently, there
