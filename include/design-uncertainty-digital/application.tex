...
left-hand side of \fref{interpolant-application}; a detailed description of the
assumed experimental setup is to be given in \sref{interpolant-results}. We
...
\fref{interpolant-application}. The quantity \g is the end-to-end delay of the
application defined in \eref{interpolant-delay}. The uncertain parameters \vu
