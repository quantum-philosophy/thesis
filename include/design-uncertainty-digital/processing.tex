At Stage~4 of our framework, the constructed hierarchical interpolant
...
one described in \sref{chaos-processing}. Namely, the analysis of \g is carried
...
Using an adequate $\transform$ discussed in \sref{interpolant-transformation},
...
unity. Therefore, using \eref{interpolant-sparse}, we have the following
