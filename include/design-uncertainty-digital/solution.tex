...
step, and $\interpolant{\nz}{\ls}$ is the interpolant at that step. From now on,
all index sets are generally subsets of their full-fledged counterparts defined
in \sref{sparse-interpolation}.
