...
The agenda for the rest of this chapter is as follows. In \sref{power-model},
the power model that we assume is described. In \sref{temperature-model}, we
present the general temperature model that is used in all the three
aforementioned types of temperature analysis. Transient analysis, static
