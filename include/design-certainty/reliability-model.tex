...
The lifetime $T$ is assumed to have a Weibull distribution as follows:
\[
...
element can still be approximated by means of \eref{weibull-reliability} by
letting
\[
...
\subsection{Thermal-Cycling Stress}
...
\sref{dynamic-steady-state} where dynamic steady-state temperature analysis is
discussed.
