...
approach to transient analysis presented in \sref{transient-state}, the
...
\sref{transient-state-present} and the accompanying eigendecomposition in
...
\sref{transient-state-present} and the one implemented in HotSpot, and the
