...
\[
  \tm{A} = -\m{C}^{-1} \m{G}.
\]
We apply a solution technique taken from the family of exponential integrators,
which have good stability properties; refer to \cite{hochbruck2010} for an
overview. Multiplying both sides of the above system by $e^{- \tm{A} t}$ and
noting that
\[
