...
motivational example in \sref{thermal-cycling-motivation}. The utilized system
and reliability models are then presented in \sref{system-model} and
...
side of \fref{thermal-cycling-motivation} where the height of a task represents
...
\fref{thermal-cycling-motivation}. If we also swap T2 and T4, the number of
