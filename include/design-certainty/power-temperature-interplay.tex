...
predefined threshold. The pseudocode of this technique in the case of dynamic
steady-state temperature analysis is given in
\aref{dynamic-steady-state-iterative}. According to our experience, it usually
takes 4--7 iterations until the uniform norm of the difference between two
successive temperature profiles drops below \celsius{0.5}.
