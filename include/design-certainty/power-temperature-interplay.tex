So far, the dependence of power on temperature, which can be seen in
\eref{static-power}, has been ignored. The dependence is positive and strong: a
...
is dissipated, which can be seen in \eref{temperature-model-original}.
