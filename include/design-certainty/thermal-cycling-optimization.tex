...
\cite{jedec2016}. Here we focus our attention on the last one, namely, thermal
cycling, and demonstrate the utility of our solution to dynamic steady-state
analysis presented in \sref{dynamic-steady-state} for mitigating the damage
caused by temperature oscillations. To this end, we develop a
thermal-cycling-aware technique for scheduling of periodic applications.
