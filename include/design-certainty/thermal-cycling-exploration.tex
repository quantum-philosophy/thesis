...
reliability models are then presented in \sref{system-model} and
...
to take into consideration the number of temperature fluctuations and their
characteristics. In order to obtain this information, dynamic steady-state
...
this context, \mq stands for the dynamic steady-state temperature profile of the
...
computed using our technique presented in \sref{dynamic-steady-state-solution}.
If the profile violates the temperature constraint in
\eref{thermal-cycling-constraints}, the chromosome is penalized proportionally
