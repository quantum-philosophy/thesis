...
In what follows, we proceed directly to Stage~4, since Stage~3, which is given
...
light representation $\interpolant{\nz}{\ls}(\g)$, which is illustrated by a
small rounded rectangle in \fref{frame-application}.
