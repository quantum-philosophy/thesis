...
operations are to be undertaken offline, whereas the trained model is supposed
to be used by the resource manager at runtime in order to make predictions and
...
training steps taken; in our experiments given in \sref{brain-results}, we use
the latter.
