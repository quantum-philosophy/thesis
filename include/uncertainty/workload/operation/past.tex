...
the required amounts of \up{CPU} and memory. The framework makes use of k-means
...
targeted at predicting \up{CPU} usage in cloud environments. It relies on
...
in \sref{brain-introduction}, the most recent advancements have not yet been
