...
reference solution, the trained model provides an error reduction of more than
46\% on average at the four time steps. This observation indicates that some
