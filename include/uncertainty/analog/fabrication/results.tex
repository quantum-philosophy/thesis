...
\sref{transient-solution}. The sampling interval of power and temperature
...
\tref{bayes-points} and \tref{bayes-instances}. The \ac{NRMSE} in
\tref{bayes-instances} has a decreasing trend; however, this trend is less
