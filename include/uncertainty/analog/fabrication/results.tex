...
opportunities for perfection for the optimization procedure. A more important
observation revealed by this experiment is that, in spite of the fact that the
inference operates on indirect and incomplete data, a thoroughly calibrated
piece of equipment can considerably improve the quality of prediction. However,
even with a noise of \celsius{2}---meaning that measurements are dispersed over
a wide band of \celsius{8} with a probability of more than 0.95---the \ac{NRMSE}
is still only 4\%.
