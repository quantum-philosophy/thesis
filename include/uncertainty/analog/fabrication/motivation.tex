...
left-hand side of \fref{bayes-example}. The gradient from blue to yellow
...
right-hand side of \fref{bayes-example}, and the locations of the measured dies
are depicted on the left-hand side of \fref{bayes-application}. It can be seen
that the two maps in \fref{bayes-example} closely match each other, implying
