...
left-hand side of \fref{bayes-motivation-distribution}. The gradient from blue
...
\sref{bayes-results}. Hence, the blue regions have a high level of power
...
the right-hand side of \fref{bayes-motivation-location} where $\g_\minimum$ is
