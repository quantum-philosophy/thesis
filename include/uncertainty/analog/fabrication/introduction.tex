...
given in \sref{bayes-motivation}. In \sref{bayes-problem}, we formulate the
problem that we address as well as the requirements for a potential solution.
The relevant prior studies are discussed in \sref{bayes-prior}. The solution
that we propose is presented in \sref{bayes-solution}, and the corresponding
experimental results are reported and elaborated on in \sref{bayes-results}.
\sref{bayes-conclusion} concludes this chapter.
