...
the boundary condition given in \eref{dynamic-steady-condition}. The pseudocode
...
be addressed via one of the techniques presented in
\sref{power-temperature-interplay}. In this section, we use the iterative
approach illustrated in \aref{dream-dynamic-steady-solution-iterative}. For
clarity, this last algorithm is rewritten here as shown in
\aref{chaos-dynamic-steady-solution-iterative}; the main difference is that the
calculation of power on line~3 is now based on \eref{chaos-power-model-bulk}.
