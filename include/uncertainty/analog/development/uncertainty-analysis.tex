...
which makes \vu fully specified; see \xref{probability-theory}. Specifically,
...
transformation; see \xref{probability-transformation} for more details.
...
discussed in \xref{sparse-integration}, a quadrature of level \lq is exact for
