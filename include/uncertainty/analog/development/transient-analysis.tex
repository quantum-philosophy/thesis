...
technique that retains the gradual solution process that is at the heart of
transient analysis; see \sref{transient-analysis}. In this way, the designer has
a fine control over transient calculations.
