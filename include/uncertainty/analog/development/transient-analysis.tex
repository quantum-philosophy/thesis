...
that it can then be propagated through \eref{chaos-recurrence-original} in order
...
\]
for $i = \range{1}{\ns}$ and $\vj \in \sparseindex{\nz}{\lc}$ where the
operation is element-wise, and it can efficiently be undertaken by virtue of a
...
\sref{sparse-integration} as well as in \sref{chaos-construction}. In the case
