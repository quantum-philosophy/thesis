...
Let us now summarize Stage~1 depicted in \fref{chaos-overview}. In this section,
...
workload specified by \f shown in \eref{chaos-power-model}. Regarding the
...
step of the process as discussed in \sref{chaos-processing}.
