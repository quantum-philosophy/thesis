...
variable (see \xref{probability-theory}), which is generally applicable to most
...
has the formula shown in \eref{index-total-order-isotropic-length}. This formula
