...
temperature $\{ \hat{\vq}_{i \vj} \}$. As discussed in \sref{polynomial-chaos},
...
natural choice is the Gauss--Jacobi quadrature; see \sref{sparse-integration}.
Then, using \eref{quadrature-summation}, the coefficient are computed as shown
in \eref{chaos-coefficient}. It is important to note that \lq should be chosen
