...
cheng2011}. Specifically, the function in \eref{inference-correlation} imposes
...
Following the guidance given in \sref{chaos-transformation}, the most suitable
...
\sref{chaos-construction}. When beta distributions are concerned, the natural
choice is the Gauss--Jacobi quadrature; see \xref{sparse-integration}. Then,
using \eref{quadrature-summation}, the coefficient are computed as shown in
