...
as those discussed in \sref{chaos-prior}. A correlation matrix, on the other
...
$\mp_\dynamic$. Similarly to \sref{bayes-results}, the modeling of the static
...
than a day, which is to be discussed further in \sref{chaos-transient-results}.
