...
is presented in \cite{lee2013}, which relies on Newton polynomials for
interpolation as well as on the \ac{KL} decomposition. In \cite{shen2009},
...
times and apply the Jarque--Bera test of normality to the collected temperature
...
\fref{chaos-application-density} described in \sref{chaos-transient-results}.
