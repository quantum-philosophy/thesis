As we elaborate in \sref{motivation} and \sref{prior}, uncertainty-unaware
...
in \sref{power-model}. The other ones are temperature-related approaches, but
...
fatigue, which is discussed in \sref{reliability-optimization}. Second, the
...
Gaussian nor log-normal, which can also be seen in \fref{chaos-example-density}
described in \sref{chaos-transient-results}.
