...
\eref{bayes-correlation}, the weight coefficient $w$ is set to 0.5, and the
...
\eref{chaos-optimization-quantity} is considered in isolation. This quantity
...
\error{Q} and \error{\life} for $\lc = 5$. The observation can be ascribed to
...
be attained by polynomial approximations. \tref{chaos-optimization-accuracy}
...
similar to those in \tref{chaos-optimization-accuracy}.
