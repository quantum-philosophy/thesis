The uncertainty originating from process variation is addressed as follows. Due
...
decomposition---which is thoroughly introduced in \xref{polynomial-chaos}---for
...
\sref{transient-analysis} and \sref{dynamic-steady-state-analysis},
...
\sref{reliability-model}, which is based on the state-of-the-art reliability
