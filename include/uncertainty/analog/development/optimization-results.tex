...
samples is set to \power{10}{4}, which is a practical assumption based on our
...
the same for the last two platforms. The magnitude of reduction is solely
determined by the assumed correlation patterns (see
...
applications are generated randomly using \up{TGFF} \cite{dick1998}. In
...
procedure. For instance, $\q_\maximum$ ranges from 90 to \celsius{120} depending
