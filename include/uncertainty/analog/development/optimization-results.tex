...
processing element occupies 2~×~2~\power{mm}{2}. The sampling interval \dt of
...
applied to the quantity shown in \eref{chaos-optimization-quantity} directly.
...
discussed in \sref{chaos-transient-results}.
