...
The general setup is the same as the one in \sref{thermal-cycling-problem}. We
...
\vu. In \aref{chaos-construction}, Algorithm~G is a subroutine that transforms
\vz into \vu, makes a call to \aref{chaos-dynamic-steady-state-iterative}, and
