...
scheme of orthogonal polynomials \cite{xiu2010}. The step is crucial, as the
rate of convergence of \ac{PC} expansions depends on it. Although there are no
...
that one might be interested in studying. This observation is of high
