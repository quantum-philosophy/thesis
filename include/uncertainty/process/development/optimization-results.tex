...
approach violate the constraint on the maximum temperature or minimum lifetime
(or both) when process variation is taken into consideration. As the problem
becomes more and more complex, the failure rate attains higher and higher
values. With 16 and 32 processing elements (320 and 640 tasks, respectively),
all the deterministic solutions violate the imposed constraints. Moreover, the
