...
each processing element occupies 4~\power{mm}{2}. The sampling interval \dt of
...
accurate. Therefore, we fix \lc (and \lq, as they are kept synchronized) to
three for the rest of the experiments.
