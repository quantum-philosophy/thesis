...
also note in \sref{network-introduction}, the most recent advancements in
machine learning have not been sufficiently explored yet in this context. In
particular, the utility of neural networks have been studied only marginally:
feed-forward networks---which are used, for instance, in \cite{kumar2010,
ismaeel2015}---are arguably the simplest and least powerful members of the
family. However, the family is rich and potent as widely demonstrated. For
instance, recurrent networks accompanied by adequate training and regularization
techniques \cite{goodfellow2016} are a salient candidate. Nonetheless, to the
best of our knowledge, they have not been studied yet for the purpose of
resource management in a large computer system.
