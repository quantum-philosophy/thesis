...
The results of the validation stage are given in \tref{network-validation},
which shows the mean squared error (\up{MSE}) of the top 10 configurations of
...
stage (see \sref{testing}), which is undertaken using $G_3$ ($0.2 \times 2
