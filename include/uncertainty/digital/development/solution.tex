...
the stage is described in \sref{interpolant-transformation}. At Stage~3, an
...
detailed in \sref{interpolant-construction}. At Stage~4, the constructed
interpolant of \g is post-processed in order to calculate the desired statistics
about \g; the stage is detailed in \sref{interpolant-processing}. In particular,
the probability distribution of \g is estimated by applying an arbitrary
sampling method to the interpolant.
