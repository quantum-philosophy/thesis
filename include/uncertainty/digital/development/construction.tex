...
form the increment given on the right-hand side of \eref{frame-interpolant}.
...
to assign a priority to a level index \vi based on the scores of the order
indices associated with this index, that is, based on the scores of
...
\sref{frame-adaptivity}. Next, we discuss the implementation.
