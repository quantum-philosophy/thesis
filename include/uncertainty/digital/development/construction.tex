...
\eref{interpolant-multiple-grid} together with \eref{quadrature-tensor-index}.
...
functions are formed as shown in \eref{interpolant-multiple-basis} together with
