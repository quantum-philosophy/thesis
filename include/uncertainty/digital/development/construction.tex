...
\eref{interpolant-sparse-surplus}, and $w_{\vi \vj}$ are products of the
one-dimensional volumes introduced in \sref{frame-basis}. The score in
\eref{frame-score} is utilized for guiding the algorithm as explained below.
...
of \g, respectively. The left-hand side of \eref{frame-stop} corresponds the
