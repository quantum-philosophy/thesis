...
\sref{chaos-processing}. Namely, the probabilistic analysis of \g is carried out
...
density function of \vz equals unity. Therefore, using \eref{frame-interpolant},
...
\]
In the above equation, $w_{\vi \vj}$ is calculated as shown in
\eref{frame-volume}.
