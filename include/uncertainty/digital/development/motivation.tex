Recall that, depending on its origin, uncertainty in electronic systems can be
...
\inputfigure{interpolant-motivation}
...
yellow line in \fref{interpolant-motivation}.
...
\fref{interpolant-motivation} shows a \ac{PC} expansion of level nine ($\lc =
...
is the blue curve in \fref{interpolant-motivation}, and the adaptively chosen
