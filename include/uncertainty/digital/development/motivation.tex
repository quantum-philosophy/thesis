Due to its physical nature, the variability coming from process variation is
...
making use of global polynomials generally work well, which is demonstrated in
...
to deliver an acceptable level of accuracy and are consequently not worth it.
