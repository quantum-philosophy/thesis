...
the processing elements can be seen in \fref{frame-application}. The quantity of
interest \g is the end-to-end delay of the application defined in
\eref{interpolant-delay}. The uncertain parameters \vu are the execution times
