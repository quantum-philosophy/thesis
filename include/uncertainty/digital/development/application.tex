...
proceeds to working solely with this interpolant, which corresponds to Stage~4
of our framework.
...
\fref{frame-application}, are subsequently used in order to estimate the
distribution of \g.
...
than the one delivered by direct sampling.
