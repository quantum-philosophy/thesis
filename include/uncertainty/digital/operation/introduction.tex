...
\inputfigure{network-application}
...
\fref{network-application} illustrates how the aforementioned prediction is
...
\fref{network-application}, our potential predictions up to four steps ahead are
...
\fref{network-application} can be of great help to the resource manager of the
