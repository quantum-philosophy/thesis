...
\sref{brain-prior}---the research in this direction has been limited. In
...
supposed to work. In this example, the \up{CPU} usage (the solid lines) of a
...
\fref{brain-application}, our potential predictions up to four steps ahead are
...
We proceed as follows. In \sref{brain-problem}, the problem that we address is
formulated. \sref{brain-prior} provides an overview of the prior work in this
context. In \sref{brain-solution}, we present our solution. The experimental
results are reported and discussed in \sref{brain-results}. Lastly,
\sref{brain-conclusion} concludes the chapter.
