...
of neural networks (to be discussed in \sref{brain-prior}), the research in this
...
represent the history of the \up{CPU} usage, which is known to the manager,
...
several steps ahead. In \fref{brain-application}, our potential predictions up
