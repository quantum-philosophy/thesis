...
at the top of \fref{brain-overview} and is explained in \sref{network-data}.
...
seen at the bottom of \fref{brain-overview}. The above operations are to be
...
one presented in \sref{network-model} has a number of hyperparameters. Examples
