...
Broadly speaking, there are two types of thermal analysis: (1) static
...
\section{Analysis of Transient Temperature} \slab{thermal-circuit}
...
\subsection{Architecture, Power, and Thermal Models} \slab{architecture-model} \slab{power-model} \slab{thermal-model}
...
\item A multiprocessor system $\Pi$ (\sref{architecture-model}).
...
\subsection{RC Thermal Circuit} \slab{thermal-circuits}
