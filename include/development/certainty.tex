...
analysis will be discussed in the following sections, \sref{transient-analysis},
\sref{static-steady-state-analysis}, and \sref{dynamic-steady-state-analysis},
respectively. The importance of the last in the context of reliability
optimization will be covered in \sref{reliability-optimization}.
...
of the system. In the case of a multiprocessor system of a chip, such a circuit
would account for all the processing elements as well as for the thermal
package.
