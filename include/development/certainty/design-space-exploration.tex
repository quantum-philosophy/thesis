...
the \up{TGFF} tool \cite{dick1998} in such a way that the execution time of
tasks is uniformly distributed between 1 and 10~ms, and the static power
...
\sref{power-temperature-interplay}. The area of one processor is
4~mm\textsuperscript{2}. The temperature constraint $\q_\maximum$ (see
