...
$\tau$ the period of the application, which is assumed to be equal to the
...
with \nt tasks and a period $\tau$ (see \sref{system-model}), and that, in this
context, \mq stands for the \up{DSSTP} of the system. The time to failure of
each processor is modeled using the reliability model presented in
