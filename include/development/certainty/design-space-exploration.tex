...
To conclude, the experimental experiments demonstrate the superiority of the
proposed approach to dynamic steady-state temperature analysis compared to the
