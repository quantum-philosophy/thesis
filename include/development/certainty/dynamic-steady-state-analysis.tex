...
The number of iterations required to reach the \ac{DSSTP} depends on the thermal
...
\ac{NRMSE}. The comparison is shown in \fref{iterative-transient-error}. It can
...
approach to transient analysis presented in \sref{transient-analysis}, the
...
\sref{dynamic-steady-state-results}. Moreover, this approximation technique
