...
\input{include/assets/figures/thermal-circuit}
In order to give a better intuition about thermal \up{RC} circuits,
\fref{thermal-circuit} depicts a simplified example of a circuit constructed for
a hypothetical dual-core chip equipped with a thermal package composed of a
