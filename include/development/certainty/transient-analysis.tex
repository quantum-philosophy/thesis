...
numerically \cite{skadron2003}; however, we are interested in obtaining an
analytical solution to the system since it has many advantages as we shall see
throughout the thesis. To this end, suppose for now that the power consumption
is constant: $\vp(t) = \vp$. Then \eref{temperature-differential-original} is a
...
what we present here as long as they do not change the fundamental properties of
$\m{C}$ and $\m{G}$.
