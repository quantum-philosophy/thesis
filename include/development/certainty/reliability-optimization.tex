...
the application is given in \fref{reliability-task-graph} along with the
...
left-hand side of \fref{reliability-thermal-cycling} where the height of a task
...
which can be seen in the middle of \fref{reliability-thermal-cycling}. If we
also swap T2 and T4, the number of cycles of P1 drops to one, which is depicted
