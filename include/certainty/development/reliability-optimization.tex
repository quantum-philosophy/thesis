...
\sref{thermal-motivation-cycling}. In \sref{thermal-cycling-problem}, we
...
\slab{thermal-motivation-cycling}
...
are shown on the left-hand side of \fref{dream-motivation-cycling} where the
