...
\fref{dream-motivation-graph} along with the execution times of the tasks for
both processing elements. The period of the application is 60~ms. The first
...
respectively; see \fref{dream-motivation-graph} for an example. The period of
the application is denoted by \period. Furthermore, each pair of a task and a
