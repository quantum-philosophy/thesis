...
\inputfigure{utopia-cycling-example}
...
are shown on the left-hand side of \fref{utopia-cycling-example} where the
...
seen in the middle of \fref{utopia-cycling-example}. If we also swap T2 and T4,
