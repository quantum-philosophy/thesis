...
\inputfigure{utopia-task-graph}
\inputfigure{utopia-cycling-motivation}
...
\fref{utopia-task-graph} along with the execution times of the tasks for both
...
are shown on the left-hand side of \fref{utopia-cycling-motivation} where the
...
seen in the middle of \fref{utopia-cycling-motivation}. If we also swap T2 and
...
respectively; see \fref{utopia-task-graph} for an example. The period of the
...
\inputtable{utopia-cycling-elements}
...
reported in \tref{utopia-cycling-elements}, which also shows the average time
...
\tref{utopia-cycling-elements}, the performed optimization does not impact much
the energy efficiency of the system.

\inputtable{utopia-cycling-tasks}
...
\tref{utopia-cycling-tasks}. The observations are similar to those made with
respect to \tref{utopia-cycling-elements}.
...
\inputtable{utopia-cycling-methods}
...
\tref{utopia-cycling-tasks} with the results produced by the two alternative
...
summarized in \tref{utopia-cycling-methods} where \ac{MTTF}\textsubscript{a} and
...
\inputfigure{utopia-cycling-pareto}
...
\fref{utopia-cycling-pareto}. It can be observed that the variation of the
