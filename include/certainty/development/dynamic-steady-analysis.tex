...
100~ms is given in \fref{dream-static-steady-example}. The processing-element
area is 25~\power{mm}{2} in this case. The reduced accuracy of this technique is
...
\fref{dream-static-steady-accuracy}. It can be seen that, for example, for an
area of 10~\power{mm}{2} and a period of 100~ms, the \ac{NRMSE} of this
