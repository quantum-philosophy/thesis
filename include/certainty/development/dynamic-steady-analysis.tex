...
solving the system in \eref{temperature-model-original} numerically by means of
...
analysis proposed in \sref{dynamic-steady-solution}. All the experiments are
conducted on a \up{GNU}/Linux machine equipped with Intel Core i7 3.4~\up{GH}z
and 8~\up{GB} of \up{RAM}.
...
\sref{dynamic-steady-prior}---and the one based on the fast Fourier
transform---which is mentioned in \sref{dynamic-steady-solution}---since they
