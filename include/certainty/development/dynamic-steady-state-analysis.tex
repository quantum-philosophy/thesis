...
\inputfigure{dream-iterative-transient-error}
\inputfigure{dream-static-steady-state-error}
...
\fref{dream-iterative-transient-error}. It can be observed that the number of
...
\fref{dream-static-steady-state-error}. It can be seen that, for example, for an
