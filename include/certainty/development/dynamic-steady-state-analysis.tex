...
\inputfigure{utopia-iterative-transient-error}
\inputfigure{utopia-static-steady-state-error}
...
\fref{utopia-iterative-transient-error}. It can be observed that the number of
...
\inputfigure{utopia-static-steady-state-example}
...
100~ms is given in \fref{utopia-static-steady-state-example}. The
...
\fref{utopia-static-steady-state-error}. It can be seen that, for example, for
an area of 10~mm\textsuperscript{2} and a period of 100~ms, the \ac{NRMSE} of
this approximation technique is close to 40\%.
...
\inputalgorithm{utopia-dynamic-steady-state}
...
solution process is given in \aref{utopia-dynamic-steady-state}.
...
\inputfigure{utopia-dynamic-steady-state-speed-steps}
...
experiment are depicted in \fref{utopia-dynamic-steady-state-speed-steps} on a
...
\inputfigure{utopia-dynamic-steady-state-speed-elements}
...
\fref{utopia-dynamic-steady-state-speed-elements}. It can be observed that the
