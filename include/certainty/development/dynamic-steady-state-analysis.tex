...
\inputfigure{dynamic-steady-state-speed}
...
experiment are depicted in \fref{dynamic-steady-state-speed-steps} on a
...
\fref{dynamic-steady-state-speed-elements}. It can be observed that the proposed
