...
power-temperature interplay, which is discussed in \sref{power-model} as well as
in \sref{power-temperature-interplay}. Consequently, in what follows, power
...
\sref{transient-analysis}, \sref{static-steady-state-analysis}, and
\sref{dynamic-steady-state-analysis}, respectively. The interdependence between
power and temperature is elaborated on in \sref{power-temperature-interplay}.
The importance of temperature analysis for design-space exploration is
illustrated in \sref{reliability-optimization} considering reliability
optimization. \sref{utopia-conclusion} concludes the chapter.
