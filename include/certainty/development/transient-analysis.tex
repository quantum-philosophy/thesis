...
change over time, that is, $\vp(t) = \vp$. In this case, the system is a system
of linear differential equations that has the following analytical solution:
...
improvement, as we discuss in the following.
