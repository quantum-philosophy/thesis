...
with such measurements implies low costs, since it might obviate the need for
deployment of specialized test structures, and in scenarios where such
structures are already available, it might require engaging only a small subset
of them.
