...
\newcommand{\applicationtitle}{Illustrative Appliation}
...
\newcommand{\priortitle}{Previous Work}
...
\renewcommand{\L}[2]{L^{#1}\left(#2\right)}
...
\def\settwo#1#2{\mathchoice{\left\{#1: #2\right\}}{\{#1: #2\}}{\{#1: #2\}}{\{#1: #2\}}}
\def\setone#1{\mathchoice{\left\{#1\right\}}{\{#1\}}{\{#1\}}{\{#1\}}}
\makeatother
