...
\newcommand{\hatnumberof}[1]{\math{{\hat{n}_\mathrm{#1}}}}
...
\newcommand{\ndm}{\hatnumberof{d}} % silicon dies measured
...
% Parameters
\renewcommand{\t}{\math{\theta}}
\newcommand{\vt}{\math{\v{\theta}}}
...
\newcommand{\measured}{\mathrm{meas}}
