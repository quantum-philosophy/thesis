...
the system by $T_\minimum$ where $\rho_\wear$ is an acceptable probability of
having a premature fault due to wear. The last two constraints in
...
the probability of the expected value of $T$; note that this expectation is a
