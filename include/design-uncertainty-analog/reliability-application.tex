...
follows:
\[
  T | (\eta, \beta) \sim \mathrm{Weibull}(\eta, \beta)
\]
...
$T$ stands for the parameterization of the reliability model, and, consequently,
it is equal to $\eta$ in the example developed in this section.
...
\[
  ...
  + \hat{\vg}_{(2)} \psi_{(2)}
\]
where $\{ \hat{\vg}_{\multiindex} \} \subset \real^3$,
\begin{align*}
  & \psi_{(0)}(\vz) = 1, \\
