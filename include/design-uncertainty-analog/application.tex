...
by $\mp_\dynamic$. Similarly to \sref{inference-result}, without loss of
...
numerically using a quadrature rule; recall \sref{chaos-surrogate-model}. When
beta distributions are concerned, the natural choice is the Gauss--Jacobi
