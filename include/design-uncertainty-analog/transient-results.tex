...
The construction of \ac{PC} expansions and quadrature rules follows the
...
10\textsuperscript{4} and 10\textsuperscript{5} in \tref{chaos-accuracy-0-5}.
...
\nz of \vz, are given in \tref{chaos-scaling-elements} where the considered
...
\tref{chaos-accuracy-0}, \tref{chaos-accuracy-0-5}, and \tref{chaos-accuracy-1},
respectively.
