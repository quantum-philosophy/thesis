...
index set given in \eref{index-total-order-anisotropic} into the isotropic one
given in \eref{index-total-order-isotropic}. Anisotropy is to be exploited in a
