...
steady-state temperature is developed in \cite{huang2009a} using \acf{PC}
expansions and the \acf{KL} decomposition; see \sref{probability-transformation}
...
times the example given in \sref{chaos-example} assuming the widespread Gaussian
...
nor log-normal, which can also be seen in \fref{chaos-example-density} described
in \sref{chaos-results}.
