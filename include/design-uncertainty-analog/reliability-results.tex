...
treated as three standard deviations. Regarding the correlation function in
...
the die (to be discussed). The model-order-reduction procedure in
\sref{probability-transformation} is set to preserve 95\% of the variance of the
problem. The tuning parameter $\gamma$ in \eref{chaos-anisotropic-weight} is set
to 0.25.
...
\hiddensubsection{Probabilistic Analysis}
