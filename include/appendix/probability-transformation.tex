...
components into a random vector $\vx_2$ with a prescribed correlation structure.
Specifically, the relationship between the two vectors is
...
In addition, the eigendecomposition decomposition provides a means of model
...
distributions and correlation matrix as $\vx_2$ and, thereby, approximates
