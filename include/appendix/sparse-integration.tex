...
An alternative construction of a multidimensional integration grid is the
...
in \sref{sparse-interpolation}; see also \cite{eldred2008, heiss2008,
...
integration grid. Note also that \eref{integration-smolyak} reduces to
\eref{integration-tensor} if we let
\[
