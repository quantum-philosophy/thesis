...
other words, a Gaussian quadrature with $n_i$ points is exact for polynomials of
order up to $2 n_i - 1$, which is a remarkable property of Gaussian quadratures
that makes such quadratures especially efficient.
...
a Gaussian quadrature with $n_i$ points is exact for polynomials of order up to
$2 i + 1$.
